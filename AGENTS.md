...
- 中央 Actions 接口：`OasisSaber/TheMasterplan/.github/workflows/themasterplan-check.yml`（v1 兼容线消费者引用 `aw-check.yml@v1`；当前版消费者引用 `themasterplan-check.yml@v4.1.0`），调用约束见 [docs/actions-interface.md](docs/actions-interface.md)，版本通道见 [docs/release-channels.md](docs/release-channels.md)
